...
urlpatterns = [
    ...
    re_path(r'^Admin_clients$', views.Admin_clients, 
        name='Admin_clients'),
    re_path(r'^Admin_clentdashboard/(?P<id>\d+)$', views.Admin_clentdashboard, 
        name='Admin_clentdashboard'),
    ...
    re_path(r'^Admin_farm_revenue$', views.Admin_farm_revenue, 
        name='Admin_farm_revenue'),
    re_path(r'^Admin_chart$', views.Admin_chart, 
        name='Admin_chart'),
    re_path(r'^Admin_add_chart$', views.Admin_add_chart, 
        name='Admin_add_chart'),
    re_path(r'Admin_viewedit_chart/(?P<id>\d+)$', views.Admin_viewedit_chart, 
        name='Admin_viewedit_chart'),
    re_path(r'Admin_chart_update/(?P<id>\d+)$', views.Admin_chart_update, 
        name='Admin_chart_update'),
