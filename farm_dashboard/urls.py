...
urlpatterns = [
    ...
    re_path(r'^Admin_plant_harvesting$', views.Admin_plant_harvesting,
        name='Admin_plant_harvesting'),
    re_path(r'^Admin_find_harvesting$', views.Admin_find_harvesting,
        name='Admin_find_harvesting'),
    re_path(r'^Admin_harvesting_list$', views.Admin_harvesting_list,
        name='Admin_harvesting_list'), 
    ...
    re_path(r'^user_plant_harvesting$', views.user_plant_harvesting,
        name='user_plant_harvesting'),
    re_path(r'^user_find_harvesting$', views.user_find_harvesting,
        name='user_find_harvesting'),
    re_path(r'^user_harvesting_list$', views.user_harvesting_list,
        name='user_harvesting_list'),  
    re_path(r'^user_add_harvesting$', views.user_add_harvesting,
        name='user_add_harvesting'),
    re_path(r'^user_viewedit_harvesting/(?P<id>\d+)$', views.user_viewedit_harvesting,
        name='user_viewedit_harvesting'),
    re_path(r'^user_harvesting_update/(?P<id>\d+)$', views.user_harvesting_update,
        name='user_harvesting_update'),
    ...
    re_path(r'^Staff_find_harvesting$', views.Staff_find_harvesting,
        name='Staff_find_harvesting'),
    re_path(r'^Staff_harvesting_list$', views.Staff_harvesting_list,
        name='Staff_harvesting_list'),  
    re_path(r'^Staff_add_harvesting$', views.Staff_add_harvesting,
        name='Staff_add_harvesting'),
    re_path(r'^Staff_viewedit_harvesting/(?P<id>\d+)$', views.Staff_viewedit_harvesting,
        name='Staff_viewedit_harvesting'),
    re_path(r'^Staff_harvesting_update/(?P<id>\d+)$', views.Staff_harvesting_update,
        name='Staff_harvesting_update'),
